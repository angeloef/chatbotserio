...
PATTERNS: list[RoutePattern] = [
    ...
    RoutePattern(
        ...
        pattern=r"^(s[ií]|si|dale|bueno|ok)\b.*\b(porfa|porfavor|por favor|gracias|mostrame|pasame|dame|detalles|fotos|quiero ver|mostr[aá])\b",
        confidence=0.88,
        needs_llm=True,
    ),
    RoutePattern(
    ...
    RoutePattern(
        name="implicit_liked",
        pattern=r"\b(me gusta|me encanta|lindo|linda|hermos[oa]|qu[eé] lindo|divino|genial|espectacular|me copa|me interesa (mucho|bastante))\b",
        confidence=0.78,
